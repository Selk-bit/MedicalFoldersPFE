...
export default class PatientRegister2 extends Component
{
    ...
    async onSubmitButton(e) {
        ...
        if (this.validator.allValid()) {
            ...
            const response = await axios.post("/registerRDossier", formData, {
            headers: {
            "Content-Type": "multipart/form-data"
                ...
                response.data == 4 ? window.location = "/medcine/pharmacien" : window.location = "/medcine/homeMS";
...
if (document.getElementById('pr2')) {
    var data = document.getElementById(('pr2')).getAttribute('data');
    ReactDOM.render(<PatientRegister2 data={data}/>, document.getElementById('pr2'));
}
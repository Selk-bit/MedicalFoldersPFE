        ...
        <div class="row">
            <div class="col-md-9 mx-auto">
                <div class="card" style="margin-top:25px; margin-bottom:25px">
                    <div class="card-header" style="background:white; color: #3F4079" ><i class="fas fa-user-md"></i> <strong>Médecin Registration</strong></div>
                    <div class="card-body">
                        <div class="mx-auto" style="width:80%">
                            <div style="margin-bottom:2rem;" id="mr" data="{{$data}}"></div>
                        </div>
                    </div>
                </div>
            </div>
